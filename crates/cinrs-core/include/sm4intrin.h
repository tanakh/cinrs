/* <sm4intrin.h> — the sm4 intrinsics, as GCC arranges them.
 *
...
#include <immintrin.h>
#else
#define _CINRS_SM4INTRIN_H

/* @generated sm4 — see crates/cinrs-core/tests/x86_intrinsics.rs */
__m256i _mm256_sm4key4_epi32(__m256i, __m256i);
__m256i _mm256_sm4rnds4_epi32(__m256i, __m256i);
__m128i _mm_sm4key4_epi32(__m128i, __m128i);
__m128i _mm_sm4rnds4_epi32(__m128i, __m128i);
/* @generated end */

#endif
#endif /* _CINRS_SM4INTRIN_H */
