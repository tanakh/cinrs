/* <avxifmaintrin.h> — the avxifma intrinsics, as GCC arranges them.
 *
...
#include <immintrin.h>
#else
#define _CINRS_AVXIFMAINTRIN_H

/* @generated avxifma — see crates/cinrs-core/tests/x86_intrinsics.rs */
__m256i _mm256_madd52hi_avx_epu64(__m256i, __m256i, __m256i);
__m256i _mm256_madd52lo_avx_epu64(__m256i, __m256i, __m256i);
__m128i _mm_madd52hi_avx_epu64(__m128i, __m128i, __m128i);
__m128i _mm_madd52lo_avx_epu64(__m128i, __m128i, __m128i);
/* @generated end */

#endif
#endif /* _CINRS_AVXIFMAINTRIN_H */
