/* <vaesintrin.h> — the vaes intrinsics, as GCC arranges them.
 *
...
#include <immintrin.h>
#else
#define _CINRS_VAESINTRIN_H

/* @generated vaes — see crates/cinrs-core/tests/x86_intrinsics.rs */
